				...
				<div class="register-block">
					<form component="register/local" class="d-flex flex-column gap-3" role="form" action="{config.relative_path}/register" method="post">
						...
						<div class="mb-2 d-flex flex-column gap-2">
							...
							<div class="d-flex flex-column">
								<select class="form-control" type="dropdown" name="role" id="role">
						...
						<div class="mb-2 d-flex flex-column gap-2">
							<label id="studentIDLabel" for="studentID" style="display: none;">ID</label>
							<div class="d-flex flex-column">
								<input class="form-control" type="text" placeholder="Enter your id number" style="display: none;" name="studentID" id="studentID" autocorrect="off" autocapitalize="off" aria-required="true"/>
							</div>
						</div>
